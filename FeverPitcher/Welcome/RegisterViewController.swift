...
class RegisterViewController: UIViewController {
    ...
    private func isTextDataImputed() -> Bool {
        ...
        return usernameTextField.text != "" && emailTextField.text != "" && cityTextField.text != "" && dateOfBirthTextField.text != "" && passwordTextFiled.text != "" && confirmPasswordTextField.text != ""
    }
    ...
    private func registerUser() {
        ...
        FUser.registerUserWith(email: emailTextField.text!, password: passwordTextFiled.text!, userName: usernameTextField.text!, city: cityTextField.text!, isMale: isMale, dateOfBirth: Date(), completion:  {
            error in
